-- Fix: handle_new_auth_user nao gerava booking_slug,
-- causando violacao not-null ao criar novos usuarios.
...
begin
  ...
  v_booking_slug := public.generate_unique_professional_slug(v_full_name);
