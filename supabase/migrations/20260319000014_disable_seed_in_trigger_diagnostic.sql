-- Diagnostic: Temporarily disable seed_default_pop_templates in trigger to isolate root cause
-- If admin user creation succeeds without seed, problem is in seed function or its RLS
...
begin
  ...
  -- DIAGNOSTIC: Seed disabled - will re-enable after confirming tenants/users inserts work
