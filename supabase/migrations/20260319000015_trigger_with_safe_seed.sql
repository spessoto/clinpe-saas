-- Re-enable seed with error handling to prevent trigger from breaking on seed failure
-- Seed failures will be silently logged but won't prevent user creation
...
begin
  ...
  exception when others then
    -- Silently log seed failure but allow user creation to proceed
    -- POP templates can be seeded manually or on-demand later
    null;
  end;
