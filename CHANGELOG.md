...
- Updated package version to `1.1.1` for documentation and release alignment.
- Minor changelog formatting improvements.

### Ops

- Verified Supabase migrations in repository `clinpe-app`: local and remote are fully synced up to `20260409000040_pop_manual_template.sql`.
